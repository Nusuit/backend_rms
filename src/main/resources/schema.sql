...
DROP TABLE IF EXISTS saved_jobs CASCADE CONSTRAINTS/
...
DROP TABLE IF EXISTS industries CASCADE CONSTRAINTS/
...
CREATE SEQUENCE JOB_SKILL_SEQ START WITH 1 INCREMENT BY 1/
CREATE SEQUENCE JOB_STAGE_SEQ START WITH 1 INCREMENT BY 1/
CREATE SEQUENCE JOBS_SEQ START WITH 1 INCREMENT BY 1/
CREATE SEQUENCE OAUTH2_SEQ START WITH 1 INCREMENT BY 1/
...
-- Tạo các bảng
CREATE TABLE roles (
                       role_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE recruiters_auth (
                                 ...
                                 email VARCHAR2(255 CHAR) UNIQUE, -- Đã đổi từ username thành email
...
CREATE TABLE recruitment_processes (
                                       recruitment_process_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
                                       name VARCHAR2(255 CHAR),
                                       PRIMARY KEY (recruitment_process_id)
)/

CREATE TABLE stages (
                        stage_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
                        name VARCHAR2(255 CHAR),
...
CREATE TABLE skills (
                        skill_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
                        name VARCHAR2(255 CHAR),
...
CREATE TABLE jobs (
                      ...
                      type VARCHAR2(255 CHAR) CHECK (type IN ('FULL_TIME','PART_TIME','CONTRACT','INTERNSHIP')),
                      max_salary NUMBER(19,0),
                      min_salary NUMBER(19,0),
                      recruiter_id NUMBER(19,0),
                      recruitment_process_id NUMBER(19,0),
                      updated_at TIMESTAMP(6),
                      benefit VARCHAR2(1020 CHAR),
...
CREATE TABLE job_skill (
                           job_skill_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE job_stage (
                           job_stage_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE schedules (
                           schedule_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
                           created_at TIMESTAMP(6),
                           job_id NUMBER(19,0),
...
CREATE TABLE applications (
                              application_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE interviews (
                            interview_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
...
CREATE TABLE industries (
                            industry_id NUMBER(19,0) GENERATED BY DEFAULT ON NULL AS IDENTITY,
                            name VARCHAR2(255 CHAR),
...
CREATE TABLE saved_jobs (
    ...
    saved_at TIMESTAMP(6) DEFAULT SYSTIMESTAMP,
    PRIMARY KEY (id),
    CONSTRAINT saved_jobs_unique UNIQUE (job_id, candidate_id)
)/
...
ALTER TABLE saved_jobs ADD CONSTRAINT FK_saved_jobs_candidate FOREIGN KEY (candidate_id) REFERENCES candidates/
ALTER TABLE saved_jobs ADD CONSTRAINT FK_saved_jobs_job FOREIGN KEY (job_id) REFERENCES jobs/
